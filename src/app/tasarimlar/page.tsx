...
export default function DesignsPage() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 pt-40 pb-16 space-y-10 md:pt-48">
      <div className="rounded-[32px] bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-10 text-white shadow-2xl shadow-slate-900/20">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-relaxed text-white/85">
          Fuar öncesi tüm konseptleri fotogerçekçi renderlar ve teknik çizimlerle sunuyor,
          markaların karar alma sürecini hızlandırıyoruz. Aşağıda son dönem projelerimizden
          seçili kareleri bulabilirsiniz.
        </p>
